...
class Komik extends BaseController
{
    ...
    {
        $this->_book_model = new KomikModel();
        $this->_book_category_model = new KomikCategoryModel();
    }
    ...
    public function create()
    {
        $data = [
            'title' => _TITLE,
            'komik_category' => $this->_book_category_model->orderBy('name_category')->findAll(),
    ...
    public function update($id)
    {
        ...
        if (!$this->validate([
            ...
            // Berisi fungsi redirect jika validasi tidak memenuhi
            // dd(\Config\Services::validation()->getErrors());
            return redirect()->to('/komik-edit/' . $slug_lama)->withInput();
        }
    ...
    {
        $data_book = $this->_book_model->where(['komik_id' => $id])->first();
