        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <button class="btn btn-primary" data-bs-target="#modalProduk" data-bs-toggle="modal"><i class="fa-solid fa-plus-circle"></i> Pilih Produk</button>
                        <button class="btn btn-dark" data-bs-target="#modalCust" data-bs-toggle="modal"><i class="fa-solid fa-magnifying-glass"></i> Cari Customer</button>
                    </div>
                </div>
