    ...
    <div class="container-fluid px-4">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <!--  -->
                <!-- Isi Report -->
                <a target="_blank" class="btn btn-primary mb-3" type="button" href="<?= base_url('jual/exportpdf') ?>"><i class="fa-solid fa-file-export"></i> Export PDF</a>
                <a class="btn btn-dark mb-3" type="button" href="<?= base_url('jual/exportexcel') ?>"><i class="fa-solid fa-file-export"></i> Export Excel</a>
                    ...
                    <tbody>
                        ...
                        foreach ($result as $value) : ?>
                            <tr>
                                ...
                                <td><a href="<?= base_url('jual/invoicepdf') ?>/<?= $value['sale_id'] ?>" class="btn btn-danger text-white"><i class="fa-solid fa-print"></i> Cetak</a></td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
                </table>
