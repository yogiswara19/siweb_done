...
<script>
    ...
    // ======== PEMBELIAN ========= //
    // function setLineChartPemb(dataset) {
    //     // Area Chart Example
    ...
    //                 dataset[val.month - 1] = val.total
    //             });
    //             setLineChartPemb(dataset)
    //         }
    //     });
    // }

    // ======== PEMBELIAN ========= // // ==== PIE CHART ==== //
    function setPieChartPemb(dataset) {
        // Pie Chart Example
        var ctx = document.getElementById("chartPembelian");
        var myPieChart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    data: dataset,
                    backgroundColor: ['#ed008c', '#d0191b', '#f06730', '#f08622', '#e9eb28', '#b4e742', '#5fc650', '#1fa5a6', '#007bff', '#000099', '#761ca2', '#b23599'],
                }],
            },
        });
    }
