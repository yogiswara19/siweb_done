                        ...
                        foreach ($dataBuku as $value) : ?>
                            <?php if ($value['stock'] != 0) : ?>
                                <tr>
                                    ...
                                    <td><?= $value['stock'] ?></td>
                                    <td>
                                        <button onclick="add_cart('<?= $value['komik_id'] ?>', '<?= $value['title'] ?>','<?= $value['price'] ?>')" class="btn btn-success">
...
<div class="modal fade" id="modalUbah" aria-hidden="true" aria-labelledby="exampleModalToggleLabel" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalToggleLabel">UBAH JUMLAH KOMIK</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <div class="row mt-3">
                    <div class="col-sm-7">
                        ...
                        <input type="number" id="qty" class="form-control" placeholder="Masukkan Jumlah Komik" min="1" value="1">
                    </div>
                    <div class="col-sm-5">
